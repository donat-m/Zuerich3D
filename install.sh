...
echo 'Downloading Unity 2018.1.1f1 pkg:'
...
echo 'Downloading Unity 2018.1.1f1 Windows Build Support pkg:'
curl --retry 5 -o Unity_win.pkg https://download.unity3d.com/download_unity/b8cbb5de9840/true
if [ $? -ne 0 ]; then { echo "Download failed"; exit $?; } fi
